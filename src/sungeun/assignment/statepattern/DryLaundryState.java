...
public class DryLaundryState implements State{
	private final Humidifier humidifier;
	
	DryLaundryState(Humidifier humidifier){
	...
	public void basicMode() {
		...
		System.out.println("빨래건조 -> 기본모드로 상태를 변경합니다.");
	...
	public void dryLaundryMode() {
		// TODO Auto-generated method stub
		System.out.println("현재 빨래건조모드로 선택되어 있습니다.");
	}

	@Override
	public void sleepMode() {
		// TODO Auto-generated method stub
		System.out.println("빨래건조 -> 수면모드로 상태를 변경합니다.");
	...
	public void operator() {
		// TODO Auto-generated method stub
		System.out.println("제습 빨래건조모드로 작동합니다.");
	}
